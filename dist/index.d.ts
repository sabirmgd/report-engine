...
export { buildPalette, buildPdfStyles, formatCurrency, hexToHsl, hslToHex, TYPOGRAPHY, SPACING, } from './core/design-tokens.js';
export type { DocumentBlock, DocumentBlockType, ReportSection, ReportDocument, BrandingConfig, CoverPageConfig, NarrativeBlock, HeadingBlock, TableBlock, ChecklistBlock, StepsBlock, LineItemsBlock, KeyValueBlock, ImageBlock, DividerBlock, CalloutBlock, } from './core/types.js';
export type { ReportFieldDef, ReportContext, ReportDefinition, ReportBuilderFn, ReportRegistry as ReportRegistryType, ReportServices, FieldResolution, } from './core/registry.js';
