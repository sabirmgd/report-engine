...
export type DocumentBlock = NarrativeBlock | HeadingBlock | TableBlock | ChecklistBlock | StepsBlock | LineItemsBlock | KeyValueBlock | ImageBlock | DividerBlock | CalloutBlock;
